...
//
// 3. Update the filepatsh to psweight.mata below.
//
...
local dir "C:\Users\kkranker\Code\Stata\psweight\code-psweight"
cd "`dir'\"

translate "`dir'\psweight.sthlp"  ///
          "`dir'\psweight.sthlp.txt"   ///
          , replace translator(smcl2txt)

translate "`dir'\psweight_class.sthlp"  ///
          "`dir'\psweight_class.sthlp.txt"   ///
          , replace translator(smcl2txt)

clear mata
do "`dir'\psweight.mata"
lmbuild lpsweight, dir("`dir'\") replace
