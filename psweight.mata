...
real scalar psweight::entropydistance(real colvector x, | real colvector w) {
  real colvector e
  real scalar sumw
  if (args()<2) {
    w=1
...
real rowvector psweight::solve(| string scalar stat, string scalar subcmd, real scalar denominator, real rowvector cvopt) {
  real rowvector beta
